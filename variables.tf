...
variable "create_linux_vmss_resource_group" {
...
variable "existing_resource_group_name" {
  description = "The name of the existing resource group to create. If not set, the name will be generated using the `org_name`, `workload_name`, `deploy_environment` and `environment` variables."
  type        = string
  default     = null
}
